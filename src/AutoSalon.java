        ...
        while (runWhile) {
            ...
            switch (k) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    addTrackToTheCar(trackList, carList);
                    break;
                case 4:
                    removeTrackFromTheCar(carList);
                    break;
                case 5:
                    printCarsList(carList);
                    break;
                case 6:
                    printTracksList(trackList);
                    break;
                case 7:
                    printCarsWithTracks(carList, trackList);
                    break;
                case 8:
                    try {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    printAllSituation(carList, trackList);
                    break;
                case 12:
                    runWhile = false;
            }
    ...
    public void printAllSituation(ArrayList<Car> list, ArrayList<Track> list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).getTrack() != null) {
                ...
                System.out.print("Авто с номером: " + list.get(i).getNumber() + " не имеет прицепа. ");
                if (list.get(i).getStatus() == 0)
                    System.out.println("Состояние - стоит");
                else if (list.get(i).getStatus() == 1)
                    System.out.println("Состояние - заведена");
        ...
        for (int i = 0; i < list2.size(); i++) {
            if (list2.get(i).getCar() != null) {
                ...
                System.out.print("Прицеп с номером: " + list2.get(i).getNumber() + " не прикреплен. ");
                if (list2.get(i).getStatus() == 0)
                    System.out.println("Состояние - стоит");
                else
                    System.out.println("Состояние - катится");
